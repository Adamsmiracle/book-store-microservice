...
public class ProductController {
  ...
  @Operation(
      ...
      description = "Returns a paginated list of products, sorted by name in ascending order.")
  @GetMapping
  ...
  @Operation(
      ...
      description = "Returns the product with the specified code, if it exists.")
  @GetMapping("/{code}")
