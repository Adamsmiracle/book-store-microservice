...
class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  // It is advisa to have a generic exception handler to catch any unhandled exceptions and return a
  ...
  // this exception handler is specifically for handling ProductNotFoundException, which is thrown
  // when a product with a specified code is not found in the catalog. It returns a 404 Not Found
  // status along with a detailed error message.
