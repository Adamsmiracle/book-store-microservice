...
@Sql("/test-data.sql") // This annotation is used to execute the SQL script before each test method
// in the class. It ensures that the database is populated with the necessary
// test data for the tests to run correctly.
